                                ...
                                this.props.locale !== item.value 
                                    ? <DropdownElement 
                                        ...
                                        path={pageContext && pageContext.originalPath
                                            ? item.value === "en" && "https://avs4you.com" + (pageContext.originalPath === "/" ? "" : pageContext.originalPath.replace(/(\/)?$/, ''))
                                            : item.value === "en" && "/"}  
                                        href={pageContext && pageContext.originalPath
                                            ? item.value !== "en" && "https://avs4you.com/" + item.value + (pageContext.originalPath === "/" ? "/" : pageContext.originalPath.replace(/(\/)?$/, ''))
                                            : item.value !== "en" && "https://avs4you.com/" + item.value}
